...
urlpatterns = [
    ...
    url(r'^(?P<quiz_id>[0-9]+)/question/(?P<question_id>[0-9]+)/answer/(?P<answer_id>[0-9]+)/', include('quipmanager.urls.urls_answer')),
    url(r'^(?P<quiz_id>[0-9]+)/question/(?P<question_id>[0-9]+)/', include('quipmanager.urls.urls_question')),
    url(r'^(?P<quiz_id>[0-9]+)/', include('quipmanager.urls.urls_quiz')),
