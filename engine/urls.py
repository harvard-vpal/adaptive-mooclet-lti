...
urlpatterns = [
    ...
    url(r'^(?P<quiz_id>[0-9]+)/question/(?P<question_id>[0-9]+)/results$', views.question_results, name='question_results'),

    # url(r'^(?P<quiz_id>[0-9]+)/question/(?P<question_id>[0-9]+)/answer/(?P<answer_id>[0-9]+)$', views.answer_detail, name='answer_detail'),
    url(r'^question/(?P<question_id>[0-9]+)/answer/(?P<answer_id>[0-9]+)$', views.answer_detail, name='answer_detail'),


    url(r'^(?P<quiz_id>[0-9]+)/question/(?P<question_id>[0-9]+)/answer/create$', views.answer_create, name='answer_create'),
    url(r'^(?P<quiz_id>[0-9]+)/question/(?P<question_id>[0-9]+)/answer/(?P<answer_id>[0-9]+)/modify$', views.answer_modify, name='answer_modify'),
